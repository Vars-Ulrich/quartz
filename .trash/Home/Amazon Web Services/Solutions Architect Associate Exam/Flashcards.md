...
The local secondary index allows you query over the entire table, across all partitions. ::: Which of the following is NOT true about the local secondary index?
